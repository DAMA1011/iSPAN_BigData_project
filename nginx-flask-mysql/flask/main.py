...
def mysqlconnection():
    return mysql.connector.connect(host='db', user='root', password='root', database='test', port=3306, charset='utf8', auth_plugin='mysql_native_password')
...
def map():
    ...
    return render_template('map.html', df=df, route=final_url, start=start, end=end, map_name=map_name2)
